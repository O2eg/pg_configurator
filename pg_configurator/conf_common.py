common_alg_set = {
    "9.6": [
        # ----------------------------------------------------------------------------------
        # Extensions
        {"name": "shared_preload_libraries", "const": "'pg_stat_statements,auto_explain'"},
        {"name": "auto_explain.log_min_duration", "const": "'3s'"},
        {"name": "auto_explain.log_analyze", "const": "true"},
        {"name": "auto_explain.log_verbose", "const": "true"},
        {"name": "auto_explain.log_buffers", "const": "true"},
        {"name": "auto_explain.log_format", "const": "text"},
        {"name": "pg_stat_statements.max", "const": "1000"},
        {"name": "pg_stat_statements.track", "const": "all"},
        # ----------------------------------------------------------------------------------
        # Logging
        ...
        {"name": "track_activity_query_size", "const": "2048"},
    ],
    "10": [{"__parent": "9.6"}],
    "11": [{"__parent": "10"}],
    "12": [{"__parent": "11"}],
