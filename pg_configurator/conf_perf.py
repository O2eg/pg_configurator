perf_alg_set = {
    ...
    "9.6": [
        ...
        },
        {
            ...
            "alg": (
                "(total_ram_in_bytes * maintenance_mem_part * "
                "autovacuum_workers_mem_part) / autovacuum_max_workers"
            ),
        },
        ...
        {"name": "autovacuum_analyze_scale_factor", "const": "0.05"},
        {
            "name": "autovacuum_vacuum_cost_limit",
            "alg": "int(calc_system_scores_scale(4000, 8000))",
            "unit": "as_is",
        },
        {"name": "vacuum_cost_limit", "alg": "autovacuum_vacuum_cost_limit"},
        {"name": "autovacuum_vacuum_cost_delay", "const": "10ms"},
        {"name": "vacuum_cost_delay", "const": "10ms"},
        {"name": "autovacuum_freeze_max_age", "const": "1200000000"},
        {"name": "autovacuum_multixact_freeze_max_age", "const": "1400000000"},
        # ----------------------------------------------------------------------------------
        # Resource Consumption
        {"name": "shared_buffers", "alg": "total_ram_in_bytes * shared_buffers_part"},
        {
            "name": "max_connections",
            "alg": "calc_connection_scale(min_conns, max_conns)",
            # where:     min_conns if CPU_CORES <= 4
            #            max_conns if CPU_CORES = max_cpu_cores
        },
        {"name": "max_files_per_process", "alg": "calc_cpu_scale(1000, 10000)"},
        {"name": "superuser_reserved_connections", "const": "4"},
        {"name": "work_mem", "alg": "calc_client_mem_values(max_connections, 0.1)[0]"},
        {
            "name": "temp_buffers",
            "alg": "calc_client_mem_values(max_connections, 0.1)[1]",
        ...
        },
        {
            ...
            "alg": (
                "(total_ram_in_bytes * maintenance_mem_part * "
                "maintenance_conns_mem_part) / maint_max_conns"
            ),
        },
        {
        ...
        },
        {
            ...
            # If synchronous_standby_names is empty, on, remote_apply, remote_write,
            # and local all wait only for the local flush to disk.
        },
        {
        ...
        {
            "name": "max_wal_size",
            # CHECKPOINT every checkpoint_timeout or near max_wal_size on disk.
            "alg": """\
                calc_system_scores_scale(
        ...
        {"name": "max_wal_senders", "alg": "10 if replication_enabled else 0", "to_unit": "as_is"},
        {
        ...
        # ----------------------------------------------------------------------------------
        # Query Planning
        {"name": "effective_cache_size", "alg": "total_ram_in_bytes - shared_buffers"},
        {"name": "default_statistics_target", "const": "1000"},
        {
            "name": "random_page_cost",
            "alg": """\
                '6' if disk_type == DiskType.SATA else \
                '4' if disk_type == DiskType.SAS else \
                '4' if disk_type == DiskType.NETWORK else \
                '1'""",  # SSD/NVMe
            "to_unit": "as_is",
        },
        {
        ...
        {"name": "max_worker_processes", "alg": """calc_cpu_scale(4, 32)"""},
        {"name": "max_parallel_workers_per_gather", "alg": "calc_cpu_scale(2, 16)"},
        # ----------------------------------------------------------------------------------
        # Lock Management
        {"name": "max_locks_per_transaction", "alg": "calc_system_scores_scale(64, 4096)"},
        {"name": "max_pred_locks_per_transaction", "alg": "calc_system_scores_scale(64, 4096)"},
        {"name": "statement_timeout", "alg": "86400000", "to_unit": "as_is"},
        {"name": "idle_in_transaction_session_timeout", "alg": "86400000", "to_unit": "as_is"},
        # ----------------------------------------------------------------------------------
    ...
    "10": [
        {"__parent": "9.6"},
        {"name": "max_parallel_workers", "alg": "calc_cpu_scale(4, 32)"},
        {
            "name": "bgwriter_lru_maxpages",
            "alg": """\
                int(
    ...
    "11": [
        ...
        {"name": "max_parallel_maintenance_workers", "alg": "calc_cpu_scale(4, 16)"},
    ],
    "12": [
        {
    ...
    "16": [
        ...
        {"name": "max_parallel_apply_workers_per_subscription", "alg": "calc_cpu_scale(4, 16)"},
    ],
    "17": [
        {
            "__parent": "16"  # inheritance
        },
        {"name": "old_snapshot_threshold", "alg": "deprecated"},
    ],
    "18": [
        {
        ...
        },
        {
            ...
            "alg": "int(calc_cpu_scale(min_autovac_workers, max_autovac_workers))",
            "to_unit": "as_is",
        },
        {"name": "io_method", "const": "worker"},
        {"name": "io_workers", "alg": "int(calc_cpu_scale(3, 16))", "to_unit": "as_is"},
        {"name": "io_max_concurrency", "alg": "int(calc_disk_scale(8, 64))", "to_unit": "as_is"},
    ],
}
