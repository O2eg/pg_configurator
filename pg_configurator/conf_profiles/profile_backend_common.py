backend_common_alg_set = {
    "9.6": [
        ...
        # update statistics after data-changing operations for affected tables.
        {
        ...
        # The auto_explain module automatically logs plans of slow statements,
        ...
        {"name": "auto_explain.log_nested_statements", "const": "true"},
        ...
        {"name": "log_line_prefix", "const": "%m [%p:%v] [%d] %r %a "},
        ...
        {"name": "lc_messages", "const": "en_US.UTF-8"},
        # ----------------------------------------------------------------------------------
